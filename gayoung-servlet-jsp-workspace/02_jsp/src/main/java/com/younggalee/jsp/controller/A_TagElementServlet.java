package com.younggalee.jsp.controller;

import com.younggalee.jsp.dto.BookDto;
import com.younggalee.jsp.dto.PersonDto;
...
public class A_TagElementServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //request객체는 이미 Servlet 단에서 선언이 되어있음 >> 바로 접근 가능
        req.setAttribute("book", bk);

        // session 객체는 servlet단에서 선언되어있지 않음 >> httpSession 객체 얻기
